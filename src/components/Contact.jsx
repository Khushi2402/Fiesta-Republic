  ...
  return (
    <div name='contact'>
      ...
      <div className='bg-slate-100 rounded-lg border border-slate-800 p-10 w-3/4'>
            <div onSubmit={handleSubmit} className='flex flex-col items-center space-y-4'>
                ...
                <input text='text' onChange={(e) => setEmail(e.target.value)} 
                placeholder='Your email address' className='border-2 rounded-xl w-auto h-8 px-4'></input>
